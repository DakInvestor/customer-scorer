...
export default function MarketingFooter() {
  return (
    <footer className="border-t border-slate-800 bg-deep-blue">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/customer-scoring-101" className="text-sm text-slate-gray hover:text-white">
                  Customer Scoring 101
                </Link>
              </li>
              <li>
                <Link href="/blog/how-to-handle-no-show-customers" className="text-sm text-slate-gray hover:text-white">
                  Handling No-Shows
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/privacy" className="text-sm text-slate-gray hover:text-white">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm text-slate-gray hover:text-white">
                  Terms of Service
                </Link>
              </li>
              <li>
                <a href="mailto:support@customerscorer.com" className="text-sm text-slate-gray hover:text-white">
                  Contact Us
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-slate-800 pt-8 md:flex-row">
          <p className="text-sm text-slate-500">
            © 2024 Customer Scorer. All rights reserved.
          </p>
