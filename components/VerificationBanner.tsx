...
export default function VerificationBanner({ status }: VerificationBannerProps) {
  ...
  if (status === "pending") {
    ...
    bannerClass += "border-forsure-blue/30 bg-forsure-blue/10";
    iconClass += "text-forsure-blue";
    textClass += "text-forsure-blue";
    buttonClass += "bg-forsure-blue/20 text-forsure-blue hover:bg-forsure-blue/30";
