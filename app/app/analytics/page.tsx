...
export default async function AnalyticsPage() {
  ...
  if (error) {
    ...
    return (
      <div className="p-8">
        <h1 className="mb-4 text-3xl font-bold text-charcoal">Analytics</h1>
    ...
    <div className="p-8">
      ...
      <div className="mb-8 grid gap-4 md:grid-cols-4">
        ...
        <div className="rounded-lg bg-surface p-5">
          ...
          <p className="mt-2 text-3xl font-semibold text-charcoal">{newInLast30}</p>
        </div>
          ...
          <table className="min-w-full text-left text-sm">
            ...
            <tbody>
              {lowestScored.map((customer) => (
                <tr key={customer.id} className="border-t border-border hover:bg-surface">
