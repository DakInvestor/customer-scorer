    ...
    <div className="min-h-screen bg-deep-blue">
        ...
        <div className="mx-auto max-w-5xl">
          <div className="space-y-16">
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row">
              <div className="flex h-48 w-full items-center justify-center rounded-2xl border border-slate-800 bg-slate-900/50 md:w-1/2">
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-forsure-blue/20">
                    <span className="text-2xl font-bold text-forsure-blue">1</span>
                  </div>
              ...
              <div className="md:w-1/2">
                <h3 className="text-2xl font-bold text-white">Add Your Customers</h3>
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row-reverse">
              <div className="flex h-48 w-full items-center justify-center rounded-2xl border border-slate-800 bg-slate-900/50 md:w-1/2">
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-forsure-blue/20">
                    <span className="text-2xl font-bold text-forsure-blue">2</span>
                  </div>
                  <div className="space-y-1">
                    <div className="mx-auto h-2 w-32 rounded bg-slate-700"></div>
              ...
              <div className="md:w-1/2">
                <h3 className="text-2xl font-bold text-white">Log Events &amp; Interactions</h3>
                <p className="mt-3 text-slate-gray">
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row">
              <div className="flex h-48 w-full items-center justify-center rounded-2xl border border-slate-800 bg-slate-900/50 md:w-1/2">
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-forsure-blue/20">
                    <span className="text-2xl font-bold text-forsure-blue">3</span>
                  </div>
              ...
              <div className="md:w-1/2">
                <h3 className="text-2xl font-bold text-white">See Reliability Scores</h3>
                <p className="mt-3 text-slate-gray">
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row-reverse">
              <div className="flex h-48 w-full items-center justify-center rounded-2xl border border-slate-800 bg-slate-900/50 md:w-1/2">
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-forsure-blue/20">
                    <span className="text-2xl font-bold text-forsure-blue">4</span>
                  </div>
                  <div className="text-2xl font-bold text-emerald">$$$</div>
                </div>
              </div>
              <div className="md:w-1/2">
                <h3 className="text-2xl font-bold text-white">Make Smarter Decisions</h3>
                <p className="mt-3 text-slate-gray">
      ...
      <section className="border-t border-slate-800 px-4 py-20">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-3xl font-bold text-white">Ready to protect your business?</h2>
