        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
            ...
            <section>
              ...
              <p>
                By accessing or using Customer Scorer ("the Platform"), you agree to be bound by these 
            ...
            <section>
              ...
              <p>
                Customer Scorer is a customer reliability tracking tool that allows businesses to 
            ...
            <section>
              <h2 className="text-xl font-semibold text-white">3. Not a Consumer Reporting Agency</h2>
              <p>
                Customer Scorer is NOT a consumer reporting agency as defined under the Fair Credit 
            ...
            <section>
              <h2 className="text-xl font-semibold text-white">5. Data Accuracy Disclaimer</h2>
              <p>
            ...
            <section>
              ...
              <p>
                To the maximum extent permitted by law, Customer Scorer and its operators shall not 
            ...
            <section>
              ...
              <p>
                For questions about these Terms, contact us at support@customerscorer.com.
              </p>
            </section>
          </div>
        </div>
